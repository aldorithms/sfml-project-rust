...
fn main() {
    let mut window: RenderWindow = RenderWindow::new((800, 600),"SFML Example", Style::CLOSE,&Default::default());
    window.set_vertical_sync_enabled(true);
    let mut texture: sfml::SfBox<Texture> = Texture::from_file("assets/sfml-icon-small.png").unwrap();
